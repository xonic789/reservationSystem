...
public class InformationVo {
	...
	public String toString() {
		return "LodgementInformationVo [information_number=" + information_number + ", information_type="
				+ information_type + ", information_notice=" + information_notice + ", information_basicInfo="
				+ information_basicInfo + ", information_comment=" + information_comment
				+ ", information_addPeopleInfo=" + information_addPeopleInfo + ", information_service="
				+ information_service + ", information_refundInfo=" + information_refundInfo + "]";
	}
