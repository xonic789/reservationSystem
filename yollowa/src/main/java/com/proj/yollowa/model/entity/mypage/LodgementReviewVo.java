...
public class LodgementReviewVo {
	...
	public LodgementReviewVo(int lodgement_number, int lodgement_userNumber, String lodgement_companyName,
			...
			int lodgement_temp, int review_reviewNumber, int review_articleNumber, int review_category,
	...
	public String toString() {
		return "LodgementReviewVo [lodgement_number=" + lodgement_number + ", lodgement_userNumber="
				...
				+ ", lodgement_temp=" + lodgement_temp + ", review_reviewNumber=" + review_reviewNumber
				+ ", review_articleNumber=" + review_articleNumber + ", review_category=" + review_category
