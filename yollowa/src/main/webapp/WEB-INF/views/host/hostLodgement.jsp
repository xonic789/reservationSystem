	...
	<div class="row">
		...
		<div id="hostInfo">
			...
			<div class="lodgementBox">
				<h5>${lodgeList.lodgement_companyName }</h5><a href="#" class="btn btn-outline-primary">상세 페이지로 이동</a><a href="addRoom/${lodgeList.lodgement_number }" class="btn btn-outline-success">방 등록 현황</a><br/>
