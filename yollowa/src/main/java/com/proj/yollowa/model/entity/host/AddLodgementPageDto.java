...
public class AddLodgementPageDto {
	...
	public AddLodgementPageDto(String lodgement_number, String lodgement_category, String lodgement_companyName,
			String lodgement_location, String lodgement_LatLng, String lodgement_hashTag, String lodgement_img,
			String lodgement_reviewCount, String lodgement_goodCount, String lodgement_reviewGradeRate,
			String lodgement_temp, String information_comment, String information_notice, String information_basicInfo,
	...
	public String toString() {
		return "AddLodgementPageDto [lodgement_number=" + lodgement_number + ", lodgement_category="
				...
				+ lodgement_location + ", lodgement_LatLng=" + lodgement_LatLng + ", lodgement_hashTag="
				+ lodgement_hashTag + ", lodgement_img=" + lodgement_img + ", lodgement_reviewCount="
				+ lodgement_reviewCount + ", lodgement_goodCount=" + lodgement_goodCount
